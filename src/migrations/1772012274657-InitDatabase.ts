...
export class InitDatabase1772012274657 implements MigrationInterface {
    name = 'InitDatabase1772012274657'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "admins" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password_hash" character varying NOT NULL, "name" character varying, "avatar" character varying, "role_id" integer, "role_name" character varying, "is_active" boolean NOT NULL DEFAULT true, "reset_token" character varying, "reset_token_expiry" TIMESTAMP, "created_by" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_051db7d37d478a69a7432df1479" UNIQUE ("email"), CONSTRAINT "PK_e3b38270c97a854c48d2e80874e" PRIMARY KEY ("id"))`);
